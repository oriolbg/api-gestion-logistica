...
public class JwtService {
	...
	@Value("${jwt.secret.key:27b76aaf16e8d087e3d0da8ad983d7d2c1192592224dc5b19c784374ef9cf382}")
	...
	private String buildToken(Map<String, Object> extraClaims, UserDetails userDetails, String expiration) {
        return Jwts.builder()
                ...
                .expiration(new Date(System.currentTimeMillis() + Long.valueOf(expiration)))
